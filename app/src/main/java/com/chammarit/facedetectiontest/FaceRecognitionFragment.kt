...
class FaceRecognitionFragment : Fragment(), View.OnClickListener {
    ...
    private var mFaceDetectionMatrix: Matrix? = null
    private var mCameraManager: CameraManager? = null
    private var mCameraCharacteristics: CameraCharacteristics? = null
    private var mSwappedDimensions: Boolean = false
            ...
            if (faces != null && mode != null) {
                if (faces.size > 0) {
                    for (i in faces.indices) {
                        Log.e("FACESCORE", faces[i].score.toString())
                        //
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        view.findViewById<Button>(R.id.picture).setOnClickListener(this)
        view.findViewById<ImageButton>(R.id.info).setOnClickListener(this)
        mTextureView = view.findViewById(R.id.texture) as AutoFitTextureView
        mOverlayView = view.findViewById(R.id.overlay_view) as OverlayView
    }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.size != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(this.context, "App Requires Permission", Toast.LENGTH_LONG).show()
        ...
        try {
            ...
            for (cameraId in mCameraManager!!.cameraIdList) {
                ...
                if (facing == CameraCharacteristics.LENS_FACING_FRONT) {
                    ...
                    Log.e("X", displaySize.x.toString())
                    ...
                    mFaceDetectionMatrix!!.setRotate(orientationOffset.toFloat())

                    Log.i(
                        "Test",
                        "activeArraySizeRect1: (" + activeArraySizeRect + ") -> " + activeArraySizeRect!!.width() + ", " + activeArraySizeRect.height()
                    )
                    Log.i(
                        "Test",
                        "activeArraySizeRect2: " + mPreviewSize!!.width + ", " + mPreviewSize!!.height
                    )
                    val s1 = mPreviewSize!!.width / activeArraySizeRect.width().toFloat()
                    val s2 = mPreviewSize!!.height / activeArraySizeRect.height().toFloat()
                    //float s1 = mOverlayView.getWidth();
                    //float s2 = mOverlayView.getHeight();
                    val mirror = true // we always use front face camera
                    val weAreinPortrait = true
                    mFaceDetectionMatrix!!.postScale(if (mirror) -s1 else s1, s2)
                    if (mSwappedDimensions) {
                        mFaceDetectionMatrix!!.postTranslate(
